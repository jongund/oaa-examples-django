   ...
   (
    ...
    ('3', 'Seizures', 'seizure',
      (
        ...
        ('2', 'Three Flashes', 'seizure-three-times', '1',),
      ),
    ),
    ('4', 'Navigable', 'navigation-mechanisms',
      (
        ...
        ('8', 'Location', 'navigation-mechanisms-location', '1',),
        ('9', 'Link Purpose (Link Only)', 'navigation-mechanisms-link', '1',),
        ('10', 'Section Headings', 'navigation-mechanisms-headings', '1',),
      ),
    ),
   ), 
  ),
