...
m1 = ElementDefinition.objects.get(attribute='role', value='presentation')
m2 = ElementDefinition.objects.get(attribute='role', value='slider')
m3 = ElementDefinition.objects.get(attribute='aria-controls')
m4 = ElementDefinition.objects.get(attribute='aria-labelledby')
m5 = ElementDefinition.objects.get(attribute='aria-valuemax')
m6 = ElementDefinition.objects.get(attribute='aria-valuemin')
m7 = ElementDefinition.objects.get(attribute='aria-valuenow')
...
example_obj.permanent_slug = 'slider1'
...
example_obj.markup = [m1,m2,m3,m4,m5,m6,m7]
